...
static constexpr auto s_tag = "[photos_gen_analyzer]";

TEST_CASE("Standard checks of photos_gen_analyzer", s_tag) {
  const std::string baseConfig{
R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("photos_gen_analyzer"
